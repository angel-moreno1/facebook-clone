...
// import reply from '../../assets/icons8-curved-arrow-24.png'
// <img src={reply} width='20rem' height='20rem' alt='reply' />
            ...
            <div className={styles.files}> 
                ...
                {/* <Popup trigger={ 
                    <div className={styles.fellings}>
                        ...
                        <button  className={styles.fellings_btn}>bad</button>
                        <button className={styles.fellings_btn}>happy</button>
                        <button className={styles.fellings_btn}>love</button>
                        <button className={styles.fellings_btn}>angry</button>
                </Popup> */}
            </div>
            {
                file || text
